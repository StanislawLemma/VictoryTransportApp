<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="EditLoad.aspx.cs"
    ClientIDMode="Static" Inherits="VictoryTransportApp.EditLoad" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="BodyContent" runat="server">
    <div class="form-horizontal">
        ...
        <div class="col-xs-11 p-2">
            <asp:Button ID="Button2" runat="server" CssClass="btn green_button" Text="Update" OnClick="btUpdateLoad_Click" />
