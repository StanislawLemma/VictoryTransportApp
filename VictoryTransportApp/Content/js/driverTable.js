...
function loadDataTable() {
    $.ajax({
        url: 'WebServices/DriverService.asmx/GetDrivers',
        method: 'post',
        dataType: 'json',
                    ...
                    { 'data': 'Address' },
                    {
                        ...
                        render: function (data, type, row, meta) {
                            return `<div class="text-center">
                                        <a href="EditDriver.aspx?id=${data}" class='btn btn-outline-success btn-sm' style='cursor:pointer;width:40%;'>
                                            Edit
                                        </a>
...
function DeleteRow(id) {
    var url = "Drivers.aspx/deleteDriver"
    ...
    swal.fire({
        ...
        if (result.isDenied) {
            ...
            $.ajax({
                ...
                data: JSON.stringify({ driver_id: id }),
                datatype: "json",
